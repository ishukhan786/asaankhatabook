  ...
  return (
    <>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11.5px", marginTop: "8px" }}>
              <thead>
                <tr style={{ borderTop: "2px solid #0f172a", borderBottom: "2px solid #0f172a", background: "transparent", color: "#0f172a", fontSize: "10.5px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                  ...
                  <th style={{ padding: "7px 8px", textAlign: "right", color: "#0f172a" }}>Credit</th>
      ...
      <Tabs defaultValue="ledger" className="space-y-6">
        <TabsList className="grid w-full max-w-lg grid-cols-2 p-1 bg-muted/20 border border-border/30 rounded-xl print:hidden">
        ...
        <TabsContent value="ledger" className="space-y-6 outline-none">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-stretch lg:items-end justify-between">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto self-stretch lg:self-auto">
              <Button 
