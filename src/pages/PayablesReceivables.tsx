...
const PrintDocument = React.memo(({
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", background: "#ffffff", color: "#111827", fontSize: "12px" }}>
      ...
      <div style={{ padding: "22px 0 18px", borderBottom: "2px solid #e5e7eb", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
      ...
      <div style={{ margin: "0", borderTop: "1px solid #e5e7eb", padding: "10px 0", display: "flex", justifyContent: "space-between" }}>
