...
export default function Receivables() {
  ...
  return (
    <>
      ...
      <div id="print-receivables-wrapper" className="hidden print:block">
        <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#ffffff", color: "#0f172a", fontSize: "11px", padding: "10px" }}>
            ...
            <div style={{ display: "flex", gap: "28px", flexWrap: "wrap" }}>
              {totals.map(([cur, amount]) => (
                <div key={cur} style={{ borderLeft: "3px solid #dc2626", paddingLeft: "10px" }}>
                  ...
                  <div style={{ fontSize: "16px", fontWeight: "900", color: "#dc2626", fontFamily: "Arial, sans-serif", marginTop: "2px" }}>
              ...
              {totals.length === 0 && (
                <div style={{ borderLeft: "3px solid #dc2626", paddingLeft: "10px" }}>
                  ...
                  <div style={{ fontSize: "16px", fontWeight: "900", color: "#dc2626", fontFamily: "Arial, sans-serif", marginTop: "2px" }}>0.00</div>
                </div>
              )}
            </div>
          </div>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((a, i) => (
                  <tr key={a.id} style={{ borderBottom: "1px solid #e2e8f0" }}>
                    ...
                    <td style={{ padding: "7px 8px", textAlign: "right", fontWeight: "900", color: "#dc2626", fontFamily: "Arial, sans-serif", fontSize: "11px" }}>
          ...
          <div style={{ marginTop: "16px", display: "flex", justifyContent: "space-between", fontSize: "8.5px", color: "#94a3b8" }}>
            <div>AsaanKhata System · Official Receivable Statement</div>
        ...
        <PageHeader
          ...
          actions={
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
              ...
              <Button onClick={() => triggerPrint("print-receivables-wrapper")} variant="outline" className="h-11 px-4 gap-2 border-2 rounded-xl font-semibold hover:bg-red-600 hover:text-white">
